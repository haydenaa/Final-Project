...
function TakeTurnState:init(battleState)
    ...
    self.playerPokemon = self.battleState.player.party.pokemon[CURRENTLY_SELECTED]
            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        function()
                            self.playerPokemon.level = self.playerPokemon.level + 1
                            gStateStack:push(StatMenuState(self.playerPokemon))
                        end))
                    else
                        self:fadeOutWhite()
                    end
