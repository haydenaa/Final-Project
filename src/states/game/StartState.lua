    ...
    if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
        ...
        function()
            ...
            gStateStack:push(DialogueState("" .. 
                "Welcome to the world of 50Mon! To start fighting monsters, just walk in the tall grass! " ..
                "If you need to heal, just press 'P' in the field! Once you've battled, press 'K' to view " ..
                "stats and change monsters. Good luck! (Press Enter to begin)" 
            ))
